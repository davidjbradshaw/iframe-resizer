...
* v3.0.1 [#234](https://github.com/davidjbradshaw/iframe-resizer/issues/234) Added option to allow iFrame to kick start init, if script is late loaded. Fixed default width in iFrame to be *scroll*, instead of *max* when called with old version of parent script. [#236](https://github.com/davidjbradshaw/iframe-resizer/issues/236) Cope with iFrames that don't have a *src* value.
