...
For ability to make only vertical scrolling, may be usefull if your frame wrapped in element with position recalculation.
...
For ability to control selector for handling links, may be usefull if you are using another functionality anchoring on '#'  
