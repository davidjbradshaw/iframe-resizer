...
describe('core/monitor/page-info', () => {
  test('getPageInfo returns stringified metrics from DOM', () => {
    const iframe = { getBoundingClientRect: () => ({ height: 100, width: 200, top: 10, left: 20 }) }
    ...
    Object.defineProperty(document.documentElement, 'clientHeight', { value: 310, configurable: true })
    Object.defineProperty(document.documentElement, 'clientWidth', { value: 410, configurable: true })
