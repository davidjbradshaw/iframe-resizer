...
vi.mock('../values/settings', () => ({ default: { a: { initChild: vi.fn(), postMessageTarget: 'win' }, b: { initChild: vi.fn(), postMessageTarget: 'other' } } }))
...
describe('core/send/ready', () => {
  test('sendIframeReady calls initChild only for matching source', () => {
    ...
    fn({ initChild: settings.a.initChild, postMessageTarget: settings.a.postMessageTarget })
    fn({ initChild: settings.b.initChild, postMessageTarget: settings.b.postMessageTarget })
