...
vi.mock('../values/settings', () => ({ default: { a: { autoResize: true, firstRun: false, iframe: { id: 'a' } }, b: { autoResize: false, firstRun: false, iframe: { id: 'b' } }, c: { autoResize: true, firstRun: true, iframe: { id: 'c' } } } }))
